...
final class IPCTests: XCTestCase {
    ...
    func testNotificationNamesAreStable() {
        XCTAssertEqual(IPC.actionNotification, "com.anywhere.action")
        XCTAssertEqual(IPC.heartbeatNotification, "com.anywhere.heartbeat")
        XCTAssertEqual(IPC.snapshotNotification, "com.anywhere.snapshot")
        XCTAssertEqual(IPC.snapshotRequestNotification, "com.anywhere.snapshot-request")
    }
